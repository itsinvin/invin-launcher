...
if [[ -n "$CARGO_PACKAGER_SIGN_PRIVATE_KEY" ]]; then
    ...
    \"downloads\": {
        \"universal\": {
            \"executable\": {
                \"download\": \"https://github.com/Moulberry/QuartzLauncher/releases/download/v$version/QuartzLauncher-macOS-Universal-Portable\",
            ...
            \"app\": {
                \"download\": \"https://github.com/Moulberry/QuartzLauncher/releases/download/v$version/QuartzLauncher.app.tar.gz\",
