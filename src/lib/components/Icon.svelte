<script lang="ts">
  // Minimal inline icon set (Lucide-style paths) to avoid a runtime icon dependency.
  interface Props {
    name: string;
    size?: number;
    class?: string;
  }
  let { name, size = 18, class: klass = '' }: Props = $props();
  ...
  const paths: Record<string, string> = {
    ...
    copy: 'M8 8h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V10a2 2 0 0 1 2-2zM16 4H4a2 2 0 0 0-2 2v12',
    ...
    gauge: 'M12 14l4-4M5.6 18.4a9 9 0 1 1 12.8 0',
    chevron: 'M9 18l6-6-6-6',
    sparkles: 'M12 3l1.9 4.6L18.5 9.5 13.9 11.4 12 16l-1.9-4.6L5.5 9.5l4.6-1.9zM19 14l.9 2.1 2.1.9-2.1.9L19 20l-.9-2.1-2.1-.9 2.1-.9z'
  };
